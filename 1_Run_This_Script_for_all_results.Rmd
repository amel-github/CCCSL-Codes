...
Script purpose: This script enables to call all scripts listed in the project and to obtain the different plots that provide a global overview of the government interventions with regard to the timeline of implementation (heat map) or aggressiveness/responsiveness of the government responses (clustering)
Date:12.07.2020.
